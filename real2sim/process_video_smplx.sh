...
echo "python stage1_reconstruction/get_mano_wilor.py \
    ...
    --hand_bbox_thr 0.8 \
    --vis"
python stage1_reconstruction/get_mano_wilor.py \
    --img_dir "./demo_data/input_images/${VIDEO_NAME}/cam01" \
    --output_dir "./demo_data/mano/${VIDEO_NAME}/cam01" \
    --pose2d_dir "./demo_data/input_2d_poses/${VIDEO_NAME}/cam01" \
    --batch_size 2 \
...
echo "python stage2_optimization/mano_smpl_to_smplx.py \
...
python stage2_optimization/mano_smpl_to_smplx.py \
    --smpl-folder "./demo_data/input_3d_meshes/${VIDEO_NAME}/cam01" \
    --mano-folder "./demo_data/mano/${VIDEO_NAME}/cam01" \
    --output-folder "./demo_data/input_smplx/${VIDEO_NAME}/cam01"
...
# Step 2: Run MegaHunter (SMPLX optimization)
echo "Step 2: Running MegaHunter (SMPLX)..."
if [ "$MEGAHUNTER_FLAGS" == "--use-g1-shape" ]; then
    echo "python -E -s stage2_optimization/megahunter_optimization.py \
        ...
        --smplx-dir \"./demo_data/input_smplx/${VIDEO_NAME}/cam01\" \
